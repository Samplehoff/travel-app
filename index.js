        ...
        var photos = '';
                    ...
                    if (typeof data.photos != 'undefined') {
                         photos = data.photos.map(function (photo) {
                             console.log(photo)
                           return `<img src="https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=${photo.photo_reference}&key=AIzaSyDtB1sgwdqbboYMS7j5HLROoyibk3wV7u0" height="150" class="card-img" alt="..."/>`
                     });
                  }
